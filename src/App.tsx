...
const Hero = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-nude-50">
      {/* Background Decorative Elements */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-[60%] h-[60%] bg-gold/5 blur-[150px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[50%] h-[50%] bg-rose/5 blur-[120px] rounded-full" />
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          <div className="flex flex-col gap-4 mb-10">
            <div className="inline-flex items-center gap-3 bg-white/50 backdrop-blur-sm border border-gold/10 py-2 px-5 rounded-full w-fit">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-gold opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-gold"></span>
              </span>
              <span className="text-[9px] uppercase tracking-[0.4em] font-black text-gold">Vivence Experience VIP</span>
            </div>
          </div>
          
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-serif leading-[1] mb-10 text-luxury-black tracking-tight">
            A Arte da <br />
            <span className="text-gradient-gold italic font-medium relative block sm:inline">
              Perfeição Natural
              <svg className="absolute -bottom-2 left-0 w-full h-2 text-gold/20" viewBox="0 0 100 10" preserveAspectRatio="none">
                <path d="M0 5 Q 25 0, 50 5 T 100 5" fill="none" stroke="currentColor" strokeWidth="2" />
              </svg>
            </span>
          </h1>
          
          <p className="text-xl md:text-2xl text-luxury-black/60 mb-12 max-w-xl leading-relaxed font-light">
            Onde a <span className="text-luxury-black font-medium">ciência de ponta</span> encontra a estética artística. Protocolos sob medida criados para revelar sua melhor versão.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 mb-20">
            ...
            <a 
              href="#procedimentos" 
              className="w-full sm:w-auto px-14 py-7 border border-luxury-black/10 text-luxury-black text-[11px] font-black uppercase tracking-[0.4em] rounded-full hover:border-gold hover:text-gold transition-all duration-500 flex items-center justify-center backdrop-blur-md bg-white/20 group"
            >
              Procedimentos
          ...
          <div className="flex flex-wrap items-center gap-x-12 gap-y-8">
            <div className="flex flex-col gap-2">
              ...
              <p className="font-serif italic text-luxury-black text-lg">"Excelência em cada detalhe"</p>
              <span className="text-[9px] uppercase font-bold text-luxury-black/40 tracking-[0.3em]">+5.000 avaliações no Google</span>
            </div>
            
            <div className="hidden sm:block w-px h-16 bg-luxury-black/10" />
            
            <div className="flex items-center gap-4">
              <div className="flex -space-x-4">
                {[1, 2, 3].map(i => (
                  <div key={i} className="w-12 h-12 rounded-full border-4 border-nude-50 overflow-hidden bg-nude-200">
                    <img src={`https://i.pravatar.cc/100?img=${i+10}`} alt="Paciente" />
                  </div>
                ))}
                <div className="w-12 h-12 rounded-full border-4 border-nude-50 bg-gold flex items-center justify-center text-[10px] font-black text-white">
                  +5K
                </div>
              </div>
              <div>
                <p className="text-[10px] uppercase font-black text-luxury-black tracking-[0.2em]">Padrão Ouro</p>
                <p className="text-sm font-medium text-luxury-black/50">Confiança máxima</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="absolute inset-[-20px] border border-gold/20 rounded-[4rem] -z-10 animate-pulse" />
            <div className="relative rounded-[3.5rem] overflow-hidden aspect-[4/5] premium-shadow group border-8 border-white/50 backdrop-blur-sm">
              <img 
                referrerPolicy="no-referrer"
                src="https://i.postimg.cc/G2RG6TKR/hero-1.png" 
                alt="Vivence Clinic - Estética de Luxo" 
                className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-[2000ms]"
              />
              <div className="absolute inset-0 bg-linear-to-t from-luxury-black/60 via-transparent to-transparent opacity-60 group-hover:opacity-40 transition-opacity" />
              ...
              <div className="absolute bottom-10 left-10 right-10 p-6 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] uppercase font-black tracking-widest text-white">Tecnologia Laser 2024</p>
                    <p className="font-serif text-lg text-white">Resultados 3x mais rápidos</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="bg-glass premium-shadow px-8 py-6 rounded-[2rem] border border-gold/30 flex flex-col items-center text-center">
              <div className="w-12 h-12 bg-gold/10 rounded-full flex items-center justify-center text-gold mb-3">
                <ShieldCheck size={28} />
              </div>
              <p className="text-[8px] uppercase font-black tracking-[0.4em] text-luxury-black/40 mb-1">Certificação</p>
              <p className="font-serif font-black text-xl text-luxury-black">ISO 9001</p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-luxury-black/90 backdrop-blur-lg premium-shadow px-8 py-5 rounded-[2rem] border border-white/10 flex items-center gap-4">
              <div className="flex flex-col">
                <div className="flex gap-0.5 text-gold text-[8px] mb-1">
                  {[1,2,3,4,5].map(i => <Star key={i} size={8} fill="currentColor" />)}
                </div>
                <p className="text-white text-xs font-bold leading-tight">Elite Diamond <br /><span className="text-white/50 text-[9px] font-normal uppercase tracking-tighter">Membro Platinum</span></p>
              </div>
              <div className="w-10 h-10 rounded-full bg-linear-to-br from-gold to-[#b38a4d] flex items-center justify-center">
          ...
          {/* Decorative Ellipse */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[130%] h-[130%] border border-gold/5 rounded-full -z-0 rotate-12" />
        </motion.div>
      </div>
    </section>
  );
...
const StatsSection = () => {
  const stats = [
    { icon: <User size={32} />, value: '+5.000', label: 'Clientes Atendidos' },
    { icon: <TrendingUp size={32} />, value: '98%', label: 'Satisfação Garantida' },
    { icon: <Award size={32} />, value: '+12', label: 'Especialistas' },
    { icon: <Calendar size={32} />, value: '7 Anos', label: 'De Experiência' },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, i) => (
            <motion.div 
              ...
              className="flex flex-col items-center text-center p-6 bg-white/50 rounded-3xl border border-gold/10 premium-shadow group hover:bg-white transition-all duration-300"
            >
              <div className="text-gold mb-4 group-hover:scale-110 transition-transform">
                {stat.icon}
              </div>
              <span className="text-3xl md:text-4xl font-serif font-bold text-luxury-black mb-1">{stat.value}</span>
              <span className="text-xs uppercase font-bold tracking-widest text-luxury-black/40">{stat.label}</span>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20 text-balance">
          ...
          >
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-serif mt-4 mb-8 leading-tight text-luxury-black">
              Tratamentos que elevam <br /> sua <span className="text-gradient-gold italic">excelência</span>
            </h2>
          ...
          {procedures.map((proc: any, i: number) => (
            ...
            >
              ...
              <div className="h-72 relative overflow-hidden shrink-0">
                ...
                {proc.isPopular && (
                  <div className="absolute top-6 right-6 px-4 py-2 bg-gold/90 text-white text-[9px] font-bold uppercase tracking-widest rounded-full shadow-lg backdrop-blur-sm">
                    Prestigio
                  </div>
                )}
...
const BenefitsSection = () => {
  const benefits = [
    { title: 'Atendimento Personalizado', desc: 'Cada paciente é único, por isso cada plano é exclusivo.' },
    { title: 'Avaliação Individual', desc: 'Mapeamento completo antes de qualquer agulha ou laser.' },
    { title: 'Resultados Naturais', desc: 'Nosso foco é realçar, não transformar seu rosto em outro.' },
    { title: 'Especialistas', desc: 'Profissionais em constante atualização nas capitais mundiais.' },
    { title: 'Protocolos Seguros', desc: 'Segurança absoluta em todos os procedimentos realizados.' },
    { title: 'Ambiente Premium', desc: 'Um spa clínico desenhado para seu total relaxamento.' },
    { title: 'Tecnologia Moderna', desc: 'Maquinário de ponta para eficiência e menos dor.' },
    { title: 'Pós-atendimento', desc: 'Acompanhamos sua evolução de perto até o resultado final.' },
  ];

  return (
    <section id="sobre" className="py-24 bg-nude-100">
      <div className="container mx-auto px-6">
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((b, i) => (
              <motion.div 
                ...
                className="bg-white p-8 rounded-[2rem] border border-gold/10 hover:border-gold/30 transition-all duration-300 premium-shadow group"
              >
                <div className="w-12 h-12 bg-gold/5 rounded-full flex items-center justify-center text-gold mb-6 group-hover:bg-gold group-hover:text-white transition-colors">
                  <CheckCircle2 size={24} />
                </div>
                <h4 className="font-serif text-xl font-bold mb-3">{b.title}</h4>
                <p className="text-sm text-luxury-black/60 leading-relaxed">{b.desc}</p>
              </motion.div>
            ))}
         </div>
      </div>
...
const TestimonialsSection = () => {
  ...
  return (
    <section id="depoimentos" className="py-24 bg-nude-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-xs uppercase tracking-[0.4em] font-bold text-rose">Vozes Reais</span>
          <h2 className="text-4xl md:text-5xl font-serif mt-4 font-bold">Quem confia na <span className="text-gold">Vivence Clinic</span></h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <motion.div 
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="bg-white p-10 rounded-[3rem] premium-shadow border border-gold/5 flex flex-col items-center text-center relative"
            >
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full overflow-hidden border-4 border-white premium-shadow">
                <img src={t.photo} alt={t.name} className="w-full h-full object-cover" />
              </div>
              <div className="mt-10 mb-4 flex gap-1 text-gold">
                {Array.from({ length: t.stars }).map((_, j) => <Star key={j} size={16} fill="currentColor" />)}
              </div>
              <p className="text-luxury-black/70 italic mb-8 leading-relaxed">"{t.text}"</p>
              <h5 className="font-serif font-bold text-lg">{t.name}</h5>
              <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-gold mt-1">{t.procedure}</span>
            </motion.div>
          ))}
        </div>
      </div>
...
const TeamSection = () => {
  const team: TeamMember[] = [
    { name: 'Dra. Beatriz Fontana', specialty: 'Dermatologia Estética', photo: 'https://i.postimg.cc/MpHjpjpp/profissional-1.jpg', bio: 'Pioneira em técnicas de harmonização preservativa com mais de 10 anos de atuação.' },
    { name: 'Dra. Helena Vaz', specialty: 'Biomedicina Estética', photo: 'https://i.postimg.cc/Qt8Djcjz/profissional-2.jpg', bio: 'Especialista em bioestimuladores e fios de sustentação pela escola francesa.' },
    { name: 'Dra. Clara Mendes', specialty: 'Cirurgiã Dentista', photo: 'https://i.postimg.cc/kgy9zjm4/profissional-5.jpg', bio: 'Focada em estética orofacial e preenchimentos avançados de alta performance.' },
  ];
  ...
  return (
    <section className="py-24 bg-nude-100">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-xs uppercase tracking-[0.4em] font-bold text-gold">Corpo Clínico</span>
          <h2 className="text-4xl md:text-5xl font-serif mt-4">Pelas mãos de <span className="italic">especialistas</span></h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {team.map((m, i) => (
            <motion.div 
              ...
              className="group"
            >
              <div className="aspect-[3/4] rounded-[3rem] overflow-hidden mb-6 premium-shadow border border-gold/10">
                <img src={m.photo} alt={m.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              </div>
              <h4 className="font-serif text-2xl font-bold text-luxury-black mb-1">{m.name}</h4>
              <p className="text-gold font-bold text-xs uppercase tracking-widest mb-4">{m.specialty}</p>
              <p className="text-sm text-luxury-black/60 mb-6">{m.bio}</p>
              <button className="text-xs font-bold uppercase tracking-widest border-b border-light-black/20 pb-1 hover:text-gold hover:border-gold transition-all">
                Conhecer Dra.
              </button>
            </motion.div>
          ))}
